...
class AuthenticationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create authentication" do
    assert_difference('Authentication.count') do
      post authentications_url, params: { authentication: { create: @authentication.create, destroy: @authentication.destroy, index: @authentication.index, provider: @authentication.provider, uid: @authentication.uid, user_id: @authentication.user_id } }
    end
  ...
  test "should update authentication" do
    patch authentication_url(@authentication), params: { authentication: { create: @authentication.create, destroy: @authentication.destroy, index: @authentication.index, provider: @authentication.provider, uid: @authentication.uid, user_id: @authentication.user_id } }
